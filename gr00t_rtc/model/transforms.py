...
class GR00TTransform(InvertibleModalityTransform):
    ...
    def _prepare_action(self, data: dict):
        ...
        # Zero-pad when the action has horizon less than 16
        n_action_tokens_raw = actions.shape[0]
        actions = np.pad(actions, ((0, self.action_horizon - n_action_tokens_raw), (0, 0)), "constant")
        ...
        actions_mask[:n_action_tokens_raw, :n_action_dims] = True
