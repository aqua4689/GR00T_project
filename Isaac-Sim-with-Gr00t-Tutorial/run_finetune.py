...
TUNE_DIFFUSION_MODEL = True # whether to tune diffusion model
DATASET_PATH = "./datasets/gr1_arms_only.Nut_pouring_task" #"./datasets/gr1_arms_only.Exhaust_pipe_sort_task"
DATASET_VIDEO_BACKEND = "decord" # torchvision_av #this is important!
MODEL_COMPUTE_DTYPE = "bfloat16"
FINETUNED_OUTPUT_DIRECTORY = "./finetuned/gr1_arms_only.Nut_pouring_batch32_nodiffusion" #"./finetuned/gr1_arms_only.Exhaust_pipe_sort_batch32_nodiffusion"
BATCH_SIZE = 32
MAX_STEPS = 40000
SAVE_STEPS = 10000 # save the model in this steps
GRADIENT_ACCUMULATION_STEPS = 1
RUN_NAME = "gr1_arms_only.Nut_pouring_batch32_nodiffusion" #"gr1_arms_only.Exhaust_pipe_sort_batch32_nodiffusion" # for reporting to wandb
LEARNING_RATE = 1e-4
